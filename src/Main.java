...
public class Main {
    ...
    public static final String LOOKUP_PHONE_NUMBER = "GN";
    public static final String EXISTS_PHONE_NUMBER = "EP";
    ...
    public static final String CONTACT_NOT_MATCH = "Phone number does not exist.";
